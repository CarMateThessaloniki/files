...
get_header( 'buddypress' ); ?>
    ...
    <?php get_template_part('page-parts/buddypress-before-wrap');?>
		...
		<form action="" method="post" id="blogs-directory-form" class="dir-form">
			...
			<h2 style="display: inline;"><?php _e( 'Site Directory', 'buddypress' ); ?></h2>
			<?php if ( is_user_logged_in() && bp_blog_signup_enabled() ) : ?> &nbsp;<a class="button radius small" href="<?php echo bp_get_root_domain() . '/' . bp_get_blogs_root_slug() . '/create/' ?>"><?php _e( 'Create a Site', 'buddypress' ); ?></a><?php endif; ?>
			<div class="clearfix" style="margin-bottom: 10px;"></div>
			<?php do_action( 'bp_before_directory_blogs_content' ); ?>

			<div id="blog-dir-search" class="dir-search" role="search">

				<?php bp_my_directory_blogs_search_form(); ?>
