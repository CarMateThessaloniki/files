<div id="buddypress">
	...
	<form action="" method="post" class="standard-form" id="doc-form">
		...
		<div id="doc-submit-options">
			...
			<input class="button radius" type="submit" name="doc-edit-submit" id="doc-edit-submit" value="<?php _e( 'Save', 'bp-docs' ) ?>"> <a href="<?php bp_docs_cancel_edit_link() ?>" class="action safe"><?php _e( 'Cancel', 'bp-docs' ); ?></a>
