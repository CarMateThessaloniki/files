...
class Kleo_Options_upload {
    ...
    */
    function render() {
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="squeen-opts-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Upload', 'kleo_framework') . '</a>';
        echo '<img class="squeen-opts-screenshot" id="squeen-opts-screenshot-' . $this->field['id'] . '" src="' . $this->value . '" />';
        echo ' <a href="javascript:void(0);" class="squeen-opts-upload-remove"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove', 'kleo_framework') . '</a>';
