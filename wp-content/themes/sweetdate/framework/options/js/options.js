...
jQuery(document).ready(function () {
    ...
    jQuery('#squeen-opts-export-code-copy').click(function () {
        if (jQuery('#squeen-opts-export-link-value').is(':visible')) {jQuery('#squeen-opts-export-link-value').fadeOut('slow'); }
        jQuery('#squeen-opts-export-code').toggle('fade');
    });

    jQuery('#squeen-opts-export-link').click(function () {
        if (jQuery('#squeen-opts-export-code').is(':visible')) {jQuery('#squeen-opts-export-code').fadeOut('slow'); }
