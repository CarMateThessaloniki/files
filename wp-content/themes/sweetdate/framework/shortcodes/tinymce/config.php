...
$kleo_shortcodes['members_online'] = array(
	...
	'params' => array(
		'field' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Member type', 'kleo_framework'),
			'desc' => 'The value to get the members after.<br> You also need to set your Sex field under Sweetdate - Buddypress',
		),
	),
	'shortcode' => '[kleo_members_online field="{{field}}"]',
