	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<?php if ( bp_is_edit_topic() ) : ?>
			...
			<div id="edit-topic">
				...
				<p class="submit"><input type="submit" name="save_changes" id="save_changes" class="button radius" value="<?php _e( 'Save Changes', 'buddypress' ); ?>" /></p>
		...
		<?php else : ?>
			...
			<div id="edit-post">
				...
				<p class="submit"><input type="submit" name="save_changes" class="button radius" id="save_changes" value="<?php _e( 'Save Changes', 'buddypress' ); ?>" /></p>
...
<?php else: ?>
	...
	<div id="message" data-alert class="alert-box">
		<?php _e( 'This topic does not exist.', 'buddypress' ); ?>
	</div>
