...
<?php if ( !bp_group_has_requested_membership() ) : ?>
	...
	<form action="<?php bp_group_form_action('request-membership'); ?>" method="post" name="request-membership-form" id="request-membership-form" class="standard-form custom">
		...
		<p><input type="submit" name="group-request-send" id="group-request-send" class="button radius" value="<?php _e( 'Send Request', 'buddypress' ); ?>" />
