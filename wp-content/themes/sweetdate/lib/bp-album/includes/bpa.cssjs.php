...
function bp_album_add_js() {
	...
	if ( $bp->current_component == $bp->album->slug )
		wp_enqueue_script( 'bp-album-js', get_template_directory_uri() .'/framework/inc/bp-album/includes/js/general.js' );
}
...
function bp_album_add_css() {
	...
	global $bp;
		...
		//wp_enqueue_style( 'bp-album-css', get_template_directory_uri().'/framework/inc/bp-album/includes/css/general.css' );
		//wp_print_styles();
}
