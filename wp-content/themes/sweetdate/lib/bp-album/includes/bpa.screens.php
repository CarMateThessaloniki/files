...
function bp_album_screen_edit_content() {
	...
	<form method="post" enctype="multipart/form-data" name="bp-album-edit-form" id="bp-album-edit-form" class="standard-form custom">
    <img alt="" id="picture-edit-thumb" src='<?php bp_album_picture_thumb_url() ?>' />
    <p>
    ...
    <?php endif; ?>
    <input type="submit" name="submit" class="button radius" id="submit" value="<?php _e( 'Save', 'bp-album' ) ?>"/>
...
function bp_album_screen_upload_content() {
	...
	<form method="post" enctype="multipart/form-data" name="bp-album-upload-form" id="bp-album-upload-form" class="standard-form custom">
    ...
    <input type="submit" class="button radius" name="submit" id="submit" value="<?php _e( 'Upload picture', 'bp-album' ) ?>"/>
		...
		if(!$error_flag){
			...
			if($pic_org_size <= $bp->album->bp_album_thumb_size){
				...
				//$pic_thumb = image_resize( $pic_mid_path, $bp->album->bp_album_thumb_size, $bp->album->bp_album_thumb_size, true);
                                $myimage = wp_get_image_editor($pic_mid_path);

                                if ( ! is_wp_error( $myimage ) ) {
                                    $myimage->resize( $bp->album->bp_album_thumb_size, $bp->album->bp_album_thumb_size, true );
                                    $myimage_thumb = $myimage->save( $pic_mid_path );
                                    $pic_thumb_path = $myimage_thumb['path'];
                                    $pic_thumb_url = str_replace($abs_path_to_files,'/',$myimage_thumb['path']);
                                }
