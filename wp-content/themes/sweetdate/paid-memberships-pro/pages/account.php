<?php
	...
	<div id="pmpro_account">		
		...
		<div id="pmpro_account-invoices" class="pmpro_box">
			<h4><?php _e("Past Invoices", "pmpro");?></h4><br>
			<ul class="table-list">
				<?php 
					$count = 0;
			...
			<?php if($count == 6) { ?>
				<p><a href="<?php echo pmpro_url("invoice"); ?>" class="small radius button bordered"><?php _e("View All Invoices", "pmpro");?></a></p>
			<?php } ?>
		</div> <!-- end pmpro_account-billing -->
		<?php } ?>
		
		<div id="pmpro_account-links" class="pmpro_box">
			<h4><?php _e("Member Links", "pmpro");?></h4><br>
			<ul class="inline-list">
				...
				<?php if((isset($ssorder->status) && $ssorder->status == "success") && (isset($ssorder->gateway) && in_array($ssorder->gateway, array("authorizenet", "paypal", "stripe")))) { ?>
					<li><a href="<?php echo pmpro_url("billing", "", "https")?>" class="small radius button secondary"><?php _e("Update Billing Information", "pmpro");?></a></li>
				<?php } ?>
				<?php if(count($pmpro_levels) > 1) { ?>
					<li><a href="<?php echo pmpro_url("levels")?>" class="small radius button"><?php _e("Change Membership Level", "pmpro");?></a></li>
				<?php } ?>
				<li><a href="<?php echo pmpro_url("cancel")?>" class="small radius button bordered"><?php _e("Cancel Membership", "pmpro");?></a></li>
				<?php 
